...
public:
  ...
  static TetrisPiece square();
  static TetrisPiece lblockLeft();
  static TetrisPiece lblockRight();
  static TetrisPiece stairblockRight();
  static TetrisPiece stairblockLeft();
  static TetrisPiece longBlock();
  static TetrisPiece threeBlock();
